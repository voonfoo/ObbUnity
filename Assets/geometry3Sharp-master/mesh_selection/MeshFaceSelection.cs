...
namespace g3
{
    public class MeshFaceSelection : IEnumerable<int>
    {
        ...
        /// </summary>
        public void FloodFill(int tSeed, Func<int,bool> TriFilterF = null, Func<int, bool> EdgeFilterF = null, Action<int> currentId = null)
        {
            FloodFill(new int[] { tSeed }, TriFilterF, EdgeFilterF, currentId);
        }
        /// <summary>
        /// Grow selection outwards from seed triangles, until it hits boundaries defined by triangle and edge filters.
        /// Edge filter is not effective unless it (possibly combined w/ triangle filter) defines closed loops.
        /// </summary>
        public void FloodFill(int[] Seeds, Func<int,bool> TriFilterF = null, Func<int,bool> EdgeFilterF = null, Action<int> currentId = null)
        {
        ...
        public async UniTask<bool> FloodFillAsync(int seeds, Func<int,bool> TriFilterF = null, Func<int,bool> EdgeFilterF = null, Action<int> currentId = null)
        {
